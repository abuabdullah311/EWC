  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-[#161616] overflow-x-hidden selection:bg-[#1292B7] selection:text-white text-center">
      ...
      <section className="relative min-h-[90vh] flex items-center pt-32 pb-24 overflow-hidden bg-white">
        ...
        <div className="absolute top-0 right-0 w-[50vw] h-[50vw] bg-blue-50/50 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4 pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-[40vw] h-[40vw] bg-teal-50/30 rounded-full blur-3xl translate-y-1/4 -translate-x-1/4 pointer-events-none"></div>
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            {/* ✅ EWC LOGO - LEFT ALIGNED (only this) */}
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold font-heading leading-[1.1] mb-8 tracking-tight text-gray-900 text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
              ...
              >
                <Button className="w-full px-10 py-4 text-lg shadow-xl shadow-blue-500/20 hover:shadow-2xl hover:shadow-blue-500/30 hover:-translate-y-1 transition-all duration-300">
      ...
      <Section background="gray" id="benefits" className="relative">
        <div className="text-center mb-20">
          <h2 className="text-3xl md:text-5xl font-bold font-heading mb-6 tracking-tight">
            Why Participate?
          </h2>
          <div className="w-24 h-1.5 brand-gradient mx-auto rounded-full opacity-80"></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
          {VALUE_PROPOSITION.map((card, idx) => (
            <div
              key={idx}
              className="bg-white p-10 rounded-3xl shadow-[0_2px_20px_rgba(0,0,0,0.04)]
                         hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)]
                         transition-all duration-300 hover:-translate-y-2 border border-gray-100/50 group"
            >
              <div className="w-16 h-16 rounded-2xl bg-blue-50/80 flex items-center justify-center mb-8 mx-auto
                              group-hover:bg-[#1292B7] group-hover:text-white transition-colors duration-300">
          ...
          {ELIGIBILITY.map((item, idx) => (
            <div
              ...
              className="bg-white rounded-3xl p-10 border border-gray-100 shadow-sm
                         hover:shadow-xl hover:border-blue-100 transition-all duration-300 hover:-translate-y-1"
            >
              ...
              {/* ✅ ONLY THIS LIST IS LEFT ALIGNED */}
      ...
      <Section background="gray" className="relative">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-50/40 via-transparent to-transparent pointer-events-none"></div>

        {/* Fancy Prize Header */}
        <div className="relative mb-24">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-200/30 via-teal-100/30 to-blue-200/30 blur-[100px] rounded-full transform -translate-y-1/2"></div>
          <div className="relative text-center z-10 bg-white/60 backdrop-blur-xl rounded-[3rem] p-16 border border-white/50 shadow-2xl max-w-5xl mx-auto ring-1 ring-gray-900/5">
            <span className="brand-gradient-text font-black tracking-[0.2em] uppercase text-sm mb-6 block">
              Global Reward
            </span>
            <h2 className="text-6xl md:text-9xl font-black font-heading mb-6 brand-gradient-text drop-shadow-sm tracking-tight">
              {PRIZE_POOL_TOTAL}
            </h2>
            <p className="text-2xl md:text-3xl text-gray-800 font-medium mb-10">
              Total Cash Prize Pool for 2026
            </p>

            <div className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#E6F4F1] text-[#0F5A4F] shadow-sm border border-[#0F5A4F]/10 hover:bg-[#D4EBE7] transition-colors">
              <CheckCircle2 className="w-6 h-6" />
              <span className="font-bold tracking-wider uppercase text-base">100% Equity Free</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
          {PRIZE_TIERS.map((tier, idx) => (
            <div
              key={idx}
              className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden relative transition-all hover:-translate-y-2 hover:shadow-2xl duration-300"
            >
              <div className="h-2 w-full brand-gradient absolute top-0 left-0"></div>
              <div className="p-10">
                <h3 className="text-2xl font-bold font-heading mb-8 text-center text-gray-900">{tier.stage}</h3>
                <div className="space-y-6">
                  {tier.prizes.map((prize, pIdx) => (
                    <div
                      key={pIdx}
                      className={`flex justify-between items-center py-4 ${pIdx !== tier.prizes.length - 1 ? 'border-b border-gray-50' : ''}`}
                    >
                      <span className="text-gray-500 font-medium flex items-center gap-3">
                        {pIdx === 0 && <Trophy className="w-5 h-5 text-yellow-500 fill-yellow-500" />}
                        {prize.position}
                      </span>
                      <span className="font-bold text-2xl text-gray-900 tracking-tight">{prize.amount}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="bg-gradient-to-br from-[#1292B7] to-[#0a6c8a] rounded-3xl p-10 md:p-14 text-white shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2"></div>
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-teal-400/20 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2"></div>

          <div className="relative z-10">
            <div className="text-center mb-12">
              <h3 className="text-3xl font-bold font-heading mb-3">AI Sub-Tracks</h3>
              <p className="text-blue-100 text-lg">Specialized prizes for cutting-edge innovation</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {AI_TRACK_PRIZES.map((track, idx) => (
                <div
                  key={idx}
                  className="bg-white/10 backdrop-blur-md p-8 rounded-2xl text-center border border-white/10 hover:bg-white/20 transition-all duration-300 hover:scale-105"
                >
                  <div className="mx-auto w-14 h-14 rounded-full bg-white/20 flex items-center justify-center mb-6 text-white shadow-inner">
                    <track.icon size={24} />
                  </div>
                  <h4 className="font-bold text-sm mb-3 h-10 flex items-center justify-center text-white/90 leading-tight">
                    {track.name}
                  </h4>
                  <p className="text-3xl font-bold text-white tracking-tight">{track.amount}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="space-y-16">
              {TIMELINE.map((event, idx) => (
                <div
                  key={idx}
                  className={`relative flex flex-col md:flex-row gap-8 items-center ${idx % 2 === 0 ? 'md:flex-row-reverse' : ''} group`}
                >
                  <div className="w-full md:w-1/2 pl-12 md:pl-0 md:px-12">
                    <div className="group-hover:-translate-y-1 transition-transform duration-300">
                      ...
                      <h3 className="text-2xl font-bold font-heading mb-3 text-gray-900">{event.title}</h3>
                      <p className="text-gray-500 text-base leading-relaxed">{event.description}</p>
                    </div>
                  </div>
      ...
      <Section className="relative overflow-hidden" background="gray">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-20 relative z-10">
          {/* left column (still center overall) */}
          <div className="lg:w-1/2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-10">
              {GLOBAL_FINALS_BENEFITS.map((benefit, idx) => (
                <div key={idx} className="flex gap-5 items-start justify-center sm:justify-start text-left">
      ...
      <section className="py-32 bg-[#111] text-white text-center relative overflow-hidden">
        <Ident className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[1200px] opacity-10" />
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-4xl">
          ...
          <div className="flex flex-col items-center gap-6">
            <a
              ...
              rel="noopener noreferrer"
            >
              <Button className="px-14 py-5 text-xl shadow-blue-900/40 shadow-2xl hover:scale-105 active:scale-95 transition-transform duration-200">
                Apply Now for EWC 2026
              </Button>
            </a>
          </div>
      ...
      {/* SECTION 9: FOOTER (Global Hosts + Founding Partner only) */}
      <footer className="bg-white pt-20 pb-12 border-t border-gray-100">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-20 text-center">
            ...
            {/* Global Hosts */}
            <div>
              <h4 className="text-xs font-bold text-gray-400 uppercase tracking-[0.2em] mb-8">
                Global Hosts
              </h4>

              {/* ✅ make logos side-by-side */}
