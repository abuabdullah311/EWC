...
import { 
  ChevronRight, ArrowRight, CheckCircle2, QrCode, 
  MapPin, Calendar, Globe, Trophy
} from 'lucide-react';
      ...
      <Section background="gray" className="relative">
        ...
        <div className="relative mb-24">
          ...
          <div className="relative text-center z-10 bg-white/60 backdrop-blur-xl rounded-[3rem] p-16 border border-white/50 shadow-2xl max-w-5xl mx-auto ring-1 ring-gray-900/5">
            ...
            <p className="text-2xl md:text-3xl text-gray-800 font-medium mb-10">Total Cash Prize Pool for 2026</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
          {PRIZE_TIERS.map((tier, idx) => (
            <div key={idx} className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden relative transition-all hover:-translate-y-2 hover:shadow-2xl duration-300">
              ...
              <div className="p-10">
                ...
                <div className="space-y-6">
                  {tier.prizes.map((prize, pIdx) => (
                    <div key={pIdx} className={`flex justify-between items-center py-4 ${pIdx !== tier.prizes.length - 1 ? 'border-b border-gray-50' : ''}`}>
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {AI_TRACK_PRIZES.map((track, idx) => (
                <div key={idx} className="bg-white/10 backdrop-blur-md p-8 rounded-2xl text-center border border-white/10 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                  <div className="mx-auto w-14 h-14 rounded-full bg-white/20 flex items-center justify-center mb-6 text-white shadow-inner">
                    <track.icon size={24} />
                  </div>
                  <h4 className="font-bold text-sm mb-3 h-10 flex items-center justify-center text-white/90 leading-tight">{track.name}</h4>
      ...
      <footer className="bg-white pt-20 pb-12 border-t border-gray-100">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-20 text-center md:text-left">
            ...
            {/* Strategic Partners */}
            <div>
              <h4 className="text-xs font-bold text-gray-400 uppercase tracking-[0.2em] mb-8">Partners</h4>
              <div className="flex flex-col gap-4">
                <span className="text-gray-600 font-medium text-lg">{HOSTS.partners}</span>
              </div>
            </div>
